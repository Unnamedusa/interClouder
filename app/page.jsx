...
const SS = {
  s(k, v) { try { localStorage.setItem('ic_' + k, JSON.stringify(v)); } catch {} },
  l(k, d) { try { const v = localStorage.getItem('ic_' + k); return v ? JSON.parse(v) : d || null; } catch { return d || null; } },
